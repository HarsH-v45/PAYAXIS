...
const worker = new Worker(
  ...
  async (job) => {
    ...
    console.log("EMPLOYEE CTC:", employee.annual_ctc);
    console.log("EMP:", employee.full_name);
    console.log("CTC:", employee.annual_ctc);
    console.log("BASIC %:", employee.basic_percent);
